...
const Loader: FC<LoaderProps> = ({ size, text, extraClass }) => {
  switch (size) {
    case "sm": {
      return (
        <div className={`block py-1 px-1 ${extraClass}`}>
          <Image
    ...
    case "md": {
      return (
        <div className={`block py-1 px-1 bg-bg-light rounded-lg ${extraClass}`}>
    ...
    default: {
      return (
        <div className={`block  border-2 rounded-lg p-3  ${extraClass}`}>
          <div className="flex justify-between ">
            <Image
              className="animate-pulse"
              alt="Loading"
              height="64"
              src={box_loader_1.src}
              width="120"
            />
            <Image
              className="animate-pulse"
